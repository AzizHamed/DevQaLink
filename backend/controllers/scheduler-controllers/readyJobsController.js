const ReadyJob = require('../../models/scheduler-models/readyJobsModel');
const moment = require('moment-timezone');
const runJob = require('../execution-controllers/jobController');

// Handle POST request to add a new ready job
exports.addReadyJob = async (req, res) => {
    try {
        const {jobId, jobName, testsToRun, resourcePool, buildVersion, jobRunType, scheduleType, createdDate, createdTime, scheduleTime, priorityLevel, activationStatus, estimatedTime, triggeredBy, resumeJob } = req.body;
...
exports.deleteJobById = async (req, res) => {
    ...
    try {
        ...
        console.log('Ready deletedJob:', deletedJob);
...
exports.updateJobById = async (req, res) => {
    try {
        ...
        if(resumeJob === "Resume"){
            runJob.processJob(updatedJobDoc);
        }
    } catch (error) {
